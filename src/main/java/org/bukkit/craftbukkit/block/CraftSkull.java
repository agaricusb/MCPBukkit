...
public class CraftSkull extends CraftBlockState implements Skull {
    ...
    public CraftSkull(final Block block) {
        ...
        player = skull.func_82120_c/*was:getExtraType*/();
        skullType = getSkullType(skull.func_82117_a/*was:getSkullType*/());
    ...
    public boolean update(boolean force) {
        ...
        if (result) {
            skull.func_82118_a/*was:setSkullType*/(getSkullType(skullType), player);
            skull.func_82116_a/*was:setRotation*/(rotation);
            skull.func_70296_d/*was:update*/();
        }
