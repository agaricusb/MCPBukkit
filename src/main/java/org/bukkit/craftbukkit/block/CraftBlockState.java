...
public class CraftBlockState implements BlockState {
    ...
    public static CraftBlockState getBlockState(net.minecraft.world.World/*was:net.minecraft.server.World*/ world, int x, int y, int z) {
    ...
    public boolean update(boolean force) {
        ...
        synchronized (block) {
            ...
            world.getHandle().func_72845_h/*was:notify*/(x, y, z);
        }
