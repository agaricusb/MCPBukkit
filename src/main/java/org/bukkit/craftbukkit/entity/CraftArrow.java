...
public class CraftArrow extends AbstractProjectile implements Arrow {
    ...
    public LivingEntity getShooter() {
        if (getHandle().field_70250_c/*was:shooter*/ != null) {
            return (LivingEntity) getHandle().field_70250_c/*was:shooter*/.getBukkitEntity();
        }
    ...
    public void setShooter(LivingEntity shooter) {
        if (shooter instanceof CraftLivingEntity) {
            getHandle().field_70250_c/*was:shooter*/ = ((CraftLivingEntity) shooter).getHandle();
        }
    }
