...
public class CraftItem extends CraftEntity implements Item {
    ...
    public ItemStack getItemStack() {
        return CraftItemStack.asCraftMirror(item.func_92059_d/*was:getItemStack*/());
    }
    ...
    public int getPickupDelay() {
        return item.field_70293_c/*was:pickupDelay*/;
    }

    public void setPickupDelay(int delay) {
        item.field_70293_c/*was:pickupDelay*/ = delay;
    }
