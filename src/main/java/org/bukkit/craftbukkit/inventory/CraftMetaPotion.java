...
class CraftMetaPotion extends CraftMetaItem implements PotionMeta {
    ...
    CraftMetaPotion(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ tag) {
        ...
        if (tag.func_74764_b/*was:hasKey*/(POTION_EFFECTS.NBT)) {
            net.minecraft.nbt.NBTTagList/*was:NBTTagList*/ list = tag.func_74761_m/*was:getList*/(POTION_EFFECTS.NBT);
            int length = list.func_74745_c/*was:size*/();
            if (length > 0) {
                customEffects = new ArrayList<PotionEffect>(length);

                for (int i = 0; i < length; i++) {
                    net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ effect = (net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/) list.func_74743_b/*was:get*/(i);
                    PotionEffectType type = PotionEffectType.getById(effect.func_74771_c/*was:getByte*/(ID.NBT));
                    int amp = effect.func_74771_c/*was:getByte*/(AMPLIFIER.NBT);
                    int duration = effect.func_74762_e/*was:getInt*/(DURATION.NBT);
                    boolean ambient = effect.func_74767_n/*was:getBoolean*/(AMBIENT.NBT);
    ...
    void applyToItem(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ tag) {
        ...
        if (hasCustomEffects()) {
            ...
            tag.func_74782_a/*was:set*/(POTION_EFFECTS.NBT, effectList);
            ...
            for (PotionEffect effect : customEffects) {
                ...
                effectData.func_74774_a/*was:setByte*/(ID.NBT, (byte) effect.getType().getId());
                effectData.func_74774_a/*was:setByte*/(AMPLIFIER.NBT, (byte) effect.getAmplifier());
                effectData.func_74768_a/*was:setInt*/(DURATION.NBT, effect.getDuration());
                effectData.func_74757_a/*was:setBoolean*/(AMBIENT.NBT, effect.isAmbient());
                effectList.func_74742_a/*was:add*/(effectData);
            }
        }
    }
