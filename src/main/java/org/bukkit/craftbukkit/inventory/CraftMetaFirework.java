...
class CraftMetaFirework extends CraftMetaItem implements FireworkMeta {
    ...
    CraftMetaFirework(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ tag) {
        ...
        if (!tag.func_74764_b/*was:hasKey*/(FIREWORKS.NBT)) {
            return;
        }

        net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ fireworks = tag.func_74775_l/*was:getCompound*/(FIREWORKS.NBT);

        power = 0xff & fireworks.func_74771_c/*was:getByte*/(FLIGHT.NBT);

        if (!fireworks.func_74764_b/*was:hasKey*/(EXPLOSIONS.NBT)) {
            return;
        }

        net.minecraft.nbt.NBTTagList/*was:NBTTagList*/ fireworkEffects = fireworks.func_74761_m/*was:getList*/(EXPLOSIONS.NBT);
        List<FireworkEffect> effects = this.effects = new ArrayList<FireworkEffect>(fireworkEffects.func_74745_c/*was:size*/());

        for (int i = 0; i < fireworkEffects.func_74745_c/*was:size*/(); i++) {
            effects.add(getEffect((net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/) fireworkEffects.func_74743_b/*was:get*/(i)));
        }
    }

    static FireworkEffect getEffect(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ explosion) {
        FireworkEffect.Builder effect = FireworkEffect.builder()
                .flicker(explosion.func_74767_n/*was:getBoolean*/(EXPLOSION_FLICKER.NBT))
                .trail(explosion.func_74767_n/*was:getBoolean*/(EXPLOSION_TRAIL.NBT))
                .with(getEffectType(0xff & explosion.func_74771_c/*was:getByte*/(EXPLOSION_TYPE.NBT)));

        for (int color : explosion.func_74759_k/*was:getIntArray*/(EXPLOSION_COLORS.NBT)) {
            effect.withColor(Color.fromRGB(color));
        }

        for (int color : explosion.func_74759_k/*was:getIntArray*/(EXPLOSION_FADE.NBT)) {
    ...
    static net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ getExplosion(FireworkEffect effect) {
        ...
        if (effect.hasFlicker()) {
            explosion.func_74757_a/*was:setBoolean*/(EXPLOSION_FLICKER.NBT, true);
        }

        if (effect.hasTrail()) {
            explosion.func_74757_a/*was:setBoolean*/(EXPLOSION_TRAIL.NBT, true);
        }

        addColors(explosion, EXPLOSION_COLORS, effect.getColors());
        addColors(explosion, EXPLOSION_FADE, effect.getFadeColors());

        explosion.func_74774_a/*was:setByte*/(EXPLOSION_TYPE.NBT, (byte) getNBT(effect.getType()));
    ...
    void applyToItem(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ itemTag) {
        ...
        net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ fireworks = itemTag.func_74775_l/*was:getCompound*/(FIREWORKS.NBT);
        itemTag.func_74766_a/*was:setCompound*/(FIREWORKS.NBT, fireworks);
        ...
        if (hasEffects()) {
            ...
            for (FireworkEffect effect : this.effects) {
                effects.func_74742_a/*was:add*/(getExplosion(effect));
            }

            if (effects.func_74745_c/*was:size*/() > 0) {
                fireworks.func_74782_a/*was:set*/(EXPLOSIONS.NBT, effects);
            }
        }

        if (hasPower()) {
            fireworks.func_74774_a/*was:setByte*/(FLIGHT.NBT, (byte) power);
        }
    }
    ...
    static void addColors(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ compound, ItemMetaKey key, List<Color> colors) {
        ...
        compound.func_74783_a/*was:setIntArray*/(key.NBT, colorArray);
    }
