...
class CraftMetaMap extends CraftMetaItem implements MapMeta {
    ...
    CraftMetaMap(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ tag) {
        ...
        if (tag.func_74764_b/*was:hasKey*/(MAP_SCALING.NBT)) {
            this.scaling = tag.func_74767_n/*was:getBoolean*/(MAP_SCALING.NBT) ? SCALING_TRUE : SCALING_FALSE;
        }
    }
    ...
    void applyToItem(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ tag) {
        ...
        if (hasScaling()) {
            tag.func_74757_a/*was:setBoolean*/(MAP_SCALING.NBT, isScaling());
        }
    }
