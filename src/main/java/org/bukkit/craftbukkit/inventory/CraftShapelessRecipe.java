...
public class CraftShapelessRecipe extends ShapelessRecipe implements CraftRecipe {
    ...
    public void addToCraftingManager() {
        ...
        for (ItemStack mdata : ingred) {
            ...
            data[i] = new net.minecraft.item.ItemStack/*was:net.minecraft.server.ItemStack*/(id, 1, dmg);
            i++;
        }
        net.minecraft.item.crafting.CraftingManager/*was:CraftingManager*/.func_77594_a/*was:getInstance*/().func_77596_b/*was:registerShapelessRecipe*/(CraftItemStack.asNMSCopy(this.getResult()), data);
    }
}
