...
public class CraftInventory implements Inventory {
    ...
    public int getSize() {
        return getInventory().func_70302_i_/*was:getSize*/();
    }

    public String getName() {
        return getInventory().func_70303_b/*was:getName*/();
    }

    public ItemStack getItem(int index) {
        net.minecraft.item.ItemStack/*was:net.minecraft.server.ItemStack*/ item = getInventory().func_70301_a/*was:getItem*/(index);
        return item == null ? null : CraftItemStack.asCraftMirror(item);
    }

    public ItemStack[] getContents() {
        ItemStack[] items = new ItemStack[getSize()];
        net.minecraft.item.ItemStack/*was:net.minecraft.server.ItemStack*/[] mcItems = getInventory().getContents();
    ...
    public void setItem(int index, ItemStack item) {
        getInventory().func_70299_a/*was:setItem*/(index, ((item == null || item.getTypeId() == 0) ? null : CraftItemStack.asNMSCopy(item)));
    }
    ...
    private int getMaxItemStack() {
        return getInventory().func_70297_j_/*was:getMaxStackSize*/();
    }
    ...
    public String getTitle() {
        return inventory.func_70303_b/*was:getName*/();
    }

    public InventoryType getType() {
        if (inventory instanceof net.minecraft.inventory.InventoryCrafting/*was:InventoryCrafting*/) {
            return inventory.func_70302_i_/*was:getSize*/() >= 9 ? InventoryType.WORKBENCH : InventoryType.CRAFTING;
    ...
    public int getMaxStackSize() {
        return inventory.func_70297_j_/*was:getMaxStackSize*/();
    }
