...
public class CraftShapedRecipe extends ShapedRecipe implements CraftRecipe {
    ...
    public void addToCraftingManager() {
        ...
        net.minecraft.item.crafting.CraftingManager/*was:CraftingManager*/.func_77594_a/*was:getInstance*/().func_92103_a/*was:registerShapedRecipe*/(CraftItemStack.asNMSCopy(this.getResult()), data);
    }
}
