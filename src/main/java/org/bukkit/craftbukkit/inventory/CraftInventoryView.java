...
public class CraftInventoryView extends InventoryView {
    ...
    public void setItem(int slot, ItemStack item) {
        ...
        if (slot != -999) {
            container.func_75139_a/*was:getSlot*/(slot).func_75215_d/*was:set*/(stack);
        } else {
            player.getHandle().func_71021_b/*was:drop*/(stack);
        }
    }
    ...
    public ItemStack getItem(int slot) {
        ...
        return CraftItemStack.asCraftMirror(container.func_75139_a/*was:getSlot*/(slot).func_75211_c/*was:getItem*/());
    }
