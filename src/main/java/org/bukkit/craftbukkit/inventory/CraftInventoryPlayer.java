...
public class CraftInventoryPlayer extends CraftInventory implements org.bukkit.inventory.PlayerInventory, EntityEquipment {
    public CraftInventoryPlayer(net.minecraft.entity.player.InventoryPlayer/*was:net.minecraft.server.PlayerInventory*/ inventory) {
        super(inventory);
    }
    ...
    public ItemStack getItemInHand() {
        return CraftItemStack.asCraftMirror(getInventory().func_70448_g/*was:getItemInHand*/());
    }
    ...
    public int getHeldItemSlot() {
        return getInventory().field_70461_c/*was:itemInHandIndex*/;
    }
    ...
    public ItemStack[] getArmorContents() {
        net.minecraft.item.ItemStack/*was:net.minecraft.server.ItemStack*/[] mcItems = getInventory().getArmorContents();
