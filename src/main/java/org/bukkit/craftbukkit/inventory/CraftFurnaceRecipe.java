...
public class CraftFurnaceRecipe extends FurnaceRecipe implements CraftRecipe {
    ...
    public void addToCraftingManager() {
        ...
        net.minecraft.item.crafting.FurnaceRecipes/*was:RecipesFurnace*/.func_77602_a/*was:getInstance*/().func_77600_a/*was:registerRecipe*/(input.getTypeId(), CraftItemStack.asNMSCopy(result), 0.1f);
    }
}
