...
class CraftMetaItem implements ItemMeta, Repairable {
    ...
    CraftMetaItem(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ tag) {
        if (tag.func_74764_b/*was:hasKey*/(DISPLAY.NBT)) {
            net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ display = tag.func_74775_l/*was:getCompound*/(DISPLAY.NBT);

            if (display.func_74764_b/*was:hasKey*/(NAME.NBT)) {
                displayName = display.func_74779_i/*was:getString*/(NAME.NBT);
            }

            if (display.func_74764_b/*was:hasKey*/(LORE.NBT)) {
                net.minecraft.nbt.NBTTagList/*was:NBTTagList*/ list = display.func_74761_m/*was:getList*/(LORE.NBT);
                lore = new ArrayList<String>(list.func_74745_c/*was:size*/());

                for (int index = 0; index < list.func_74745_c/*was:size*/(); index++) {
                    String line = ((net.minecraft.nbt.NBTTagString/*was:NBTTagString*/) list.func_74743_b/*was:get*/(index)).field_74751_a/*was:data*/;
                    lore.add(line);
                }
            }
        }
        ...
        if (tag.func_74764_b/*was:hasKey*/(REPAIR.NBT)) {
            repairCost = tag.func_74762_e/*was:getInt*/(REPAIR.NBT);
        }
    }

    static Map<Enchantment, Integer> buildEnchantments(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ tag, ItemMetaKey key) {
        if (!tag.func_74764_b/*was:hasKey*/(key.NBT)) {
            return null;
        }

        net.minecraft.nbt.NBTTagList/*was:NBTTagList*/ ench = tag.func_74761_m/*was:getList*/(key.NBT);
        Map<Enchantment, Integer> enchantments = new HashMap<Enchantment, Integer>(ench.func_74745_c/*was:size*/());

        for (int i = 0; i < ench.func_74745_c/*was:size*/(); i++) {
            int id = 0xffff & ((net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/) ench.func_74743_b/*was:get*/(i)).func_74765_d/*was:getShort*/(ENCHANTMENTS_ID.NBT);
            int level = 0xffff & ((net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/) ench.func_74743_b/*was:get*/(i)).func_74765_d/*was:getShort*/(ENCHANTMENTS_LVL.NBT);
    ...
    void applyToItem(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ itemTag) {
        ...
        if (hasRepairCost()) {
            itemTag.func_74768_a/*was:setInt*/(REPAIR.NBT, repairCost);
        }
    }
    ...
    static net.minecraft.nbt.NBTTagList/*was:NBTTagList*/ createStringList(List<String> list, ItemMetaKey key) {
        ...
        for (int i = 0; i < list.size(); i++) {
            tagList.func_74742_a/*was:add*/(new net.minecraft.nbt.NBTTagString/*was:NBTTagString*/("", list.get(i)));
        }
    ...
    static void applyEnchantments(Map<Enchantment, Integer> enchantments, net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ tag, ItemMetaKey key) {
        ...
        for (Map.Entry<Enchantment, Integer> entry : enchantments.entrySet()) {
            ...
            subtag.func_74777_a/*was:setShort*/(ENCHANTMENTS_ID.NBT, (short) entry.getKey().getId());
            subtag.func_74777_a/*was:setShort*/(ENCHANTMENTS_LVL.NBT, entry.getValue().shortValue());

            list.func_74742_a/*was:add*/(subtag);
        }

        tag.func_74782_a/*was:set*/(key.NBT, list);
    }
    ...
    void setDisplayTag(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ tag, String key, net.minecraft.nbt.NBTBase/*was:NBTBase*/ value) {
        final net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ display = tag.func_74775_l/*was:getCompound*/(DISPLAY.NBT);

        if (!tag.func_74764_b/*was:hasKey*/(DISPLAY.NBT)) {
            tag.func_74766_a/*was:setCompound*/(DISPLAY.NBT, display);
        }

        display.func_74782_a/*was:set*/(key, value);
    }
