...
class CraftMetaBook extends CraftMetaItem implements BookMeta {
    ...
    CraftMetaBook(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ tag) {
        ...
        if (tag.func_74764_b/*was:hasKey*/(BOOK_TITLE.NBT)) {
            this.title = tag.func_74779_i/*was:getString*/(BOOK_TITLE.NBT);
        }

        if (tag.func_74764_b/*was:hasKey*/(BOOK_AUTHOR.NBT)) {
            this.author = tag.func_74779_i/*was:getString*/(BOOK_AUTHOR.NBT);
        }

        if (tag.func_74764_b/*was:hasKey*/(BOOK_PAGES.NBT)) {
            net.minecraft.nbt.NBTTagList/*was:NBTTagList*/ pages = tag.func_74761_m/*was:getList*/(BOOK_PAGES.NBT);
            String[] pageArray = new String[pages.func_74745_c/*was:size*/()];

            for (int i = 0; i < pages.func_74745_c/*was:size*/(); i++) {
                String page = ((net.minecraft.nbt.NBTTagString/*was:NBTTagString*/) pages.func_74743_b/*was:get*/(i)).field_74751_a/*was:data*/;
                pageArray[i] = page;
            }
    ...
    void applyToItem(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ itemData) {
        ...
        if (hasTitle()) {
            itemData.func_74778_a/*was:setString*/(BOOK_TITLE.NBT, this.title);
        }

        if (hasAuthor()) {
            itemData.func_74778_a/*was:setString*/(BOOK_AUTHOR.NBT, this.author);
        }

        if (hasPages()) {
            itemData.func_74782_a/*was:set*/(BOOK_PAGES.NBT, createStringList(pages, BOOK_PAGES));
        }
    }
