...
class CraftMetaSkull extends CraftMetaItem implements SkullMeta {
    ...
    CraftMetaSkull(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ tag) {
        ...
        if (tag.func_74764_b/*was:hasKey*/(SKULL_OWNER.NBT)) {
            player = tag.func_74779_i/*was:getString*/(SKULL_OWNER.NBT);
        }
    }
    ...
    void applyToItem(net.minecraft.nbt.NBTTagCompound/*was:NBTTagCompound*/ tag) {
        ...
        if (hasOwner()) {
            tag.func_74778_a/*was:setString*/(SKULL_OWNER.NBT, player);
        }
    }
