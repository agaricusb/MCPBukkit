...
public class BlockPistonBase extends Block
{
    ...
    public int func_71858_a(int p_71858_1_, int p_71858_2_)
    {
        ...
        return k > 5 ? this.field_72059_bZ : (p_71858_1_ == k ? (!func_72114_f(p_71858_2_) && this.field_72026_ch <= 0.0D && this.field_72023_ci <= 0.0D && this.field_72024_cj <= 0.0D && this.field_72021_ck >= 1.0D && this.field_72022_cl >= 1.0D && this.field_72019_cm >= 1.0D ? this.field_72059_bZ : 110) : (p_71858_1_ == Facing.field_71588_a[k] ? 109 : 108));
    }
    ...
    {
        int l = func_72116_b(p_71860_1_, p_71860_2_, p_71860_3_, p_71860_4_, (EntityPlayer)p_71860_5_);
    ...
    public void func_71883_b(World p_71883_1_, int p_71883_2_, int p_71883_3_, int p_71883_4_, int p_71883_5_, int p_71883_6_)
    {
        ...
        else if (p_71883_5_ == 1)
        {
            ...
            if (this.field_72119_a)
            {
                ...
                if (!flag && i2 > 0 && func_72111_a(i2, p_71883_1_, j1, k1, l1, false) && (Block.field_71973_m[i2].func_71915_e() == 0 || i2 == Block.field_71963_Z.field_71990_ca || i2 == Block.field_71956_V.field_71990_ca))
                {
                    ...
                    p_71883_1_.func_72961_c(p_71883_2_, p_71883_3_, p_71883_4_, Block.field_72095_ac.field_71990_ca, j2);
                    p_71883_1_.func_72837_a(p_71883_2_, p_71883_3_, p_71883_4_, BlockPistonMoving.func_72297_a(i2, j2, p_71883_6_, false, false));
                    p_71883_1_.func_72859_e(j1, k1, l1, 0);
                }
                else if (!flag)
                {
        ...
        while (true)
        {
            ...
            if (l1 < 13)
            {
                ...
                if (i2 != 0)
                {
                    ...
                    p_72115_1_.func_72859_e(i1, j1, k1, 0);
                }
            }

            while (i1 != p_72115_2_ || j1 != p_72115_3_ || k1 != p_72115_4_)
            {
                l1 = i1 - Facing.field_71586_b[p_72115_5_];
                i2 = j1 - Facing.field_71587_c[p_72115_5_];
                int j2 = k1 - Facing.field_71585_d[p_72115_5_];
                int k2 = p_72115_1_.func_72798_a(l1, i2, j2);
                int l2 = p_72115_1_.func_72805_g(l1, i2, j2);

                if (k2 == this.field_71990_ca && l1 == p_72115_2_ && i2 == p_72115_3_ && j2 == p_72115_4_)
                {
                    p_72115_1_.func_72930_a(i1, j1, k1, Block.field_72095_ac.field_71990_ca, p_72115_5_ | (this.field_72119_a ? 8 : 0), false);
                ...
                {
                    p_72115_1_.func_72930_a(i1, j1, k1, Block.field_72095_ac.field_71990_ca, l2, false);
                    p_72115_1_.func_72837_a(i1, j1, k1, BlockPistonMoving.func_72297_a(k2, l2, p_72115_5_, true, false));
                }
