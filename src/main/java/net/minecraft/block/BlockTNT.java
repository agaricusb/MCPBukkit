...
public class BlockTNT extends Block
{
    ...
    public void func_71861_g(World p_71861_1_, int p_71861_2_, int p_71861_3_, int p_71861_4_)
    {
        ...
        if (!p_71861_1_.field_73014_t && p_71861_1_.func_72864_z(p_71861_2_, p_71861_3_, p_71861_4_))   // CraftBukkit
        {
    ...
    public void func_71867_k(World p_71867_1_, int p_71867_2_, int p_71867_3_, int p_71867_4_)
    {
        ...
        {
            EntityTNTPrimed entitytntprimed = new EntityTNTPrimed(p_71867_1_, (double)((float)p_71867_2_ + 0.5F), (double)((float)p_71867_3_ + 0.5F), (double)((float)p_71867_4_ + 0.5F));
    ...
    public void func_71898_d(World p_71898_1_, int p_71898_2_, int p_71898_3_, int p_71898_4_, int p_71898_5_)
    {
        if (!p_71898_1_.field_72995_K)
        {
            if ((p_71898_5_ & 1) == 1)
            {
                EntityTNTPrimed entitytntprimed = new EntityTNTPrimed(p_71898_1_, (double)((float)p_71898_2_ + 0.5F), (double)((float)p_71898_3_ + 0.5F), (double)((float)p_71898_4_ + 0.5F));
