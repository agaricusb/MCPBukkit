...
public class BlockLever extends Block
{
    ...
    public int func_85104_a(World p_85104_1_, int p_85104_2_, int p_85104_3_, int p_85104_4_, int p_85104_5_, float p_85104_6_, float p_85104_7_, float p_85104_8_, int p_85104_9_)
    {
        ...
        {
            k1 = p_85104_1_.field_73012_v.nextBoolean() ? 0 : 7;
        }

        if (p_85104_5_ == 1 && p_85104_1_.func_72797_t(p_85104_2_, p_85104_3_ - 1, p_85104_4_))
        {
            k1 = 5 + p_85104_1_.field_73012_v.nextInt(2);
        }
    ...
    public boolean func_71855_c(IBlockAccess p_71855_1_, int p_71855_2_, int p_71855_3_, int p_71855_4_, int p_71855_5_)
    {
        ...
        {
            int j1 = i1 & 7;
            return j1 == 0 && p_71855_5_ == 0 ? true : (j1 == 7 && p_71855_5_ == 0 ? true : (j1 == 6 && p_71855_5_ == 1 ? true : (j1 == 5 && p_71855_5_ == 1 ? true : (j1 == 4 && p_71855_5_ == 2 ? true : (j1 == 3 && p_71855_5_ == 3 ? true : (j1 == 2 && p_71855_5_ == 4 ? true : j1 == 1 && p_71855_5_ == 5))))));
        }
    }
