...
public class BlockButton extends Block
{
    ...
    public boolean func_71903_a(World p_71903_1_, int p_71903_2_, int p_71903_3_, int p_71903_4_, EntityPlayer p_71903_5_, int p_71903_6_, float p_71903_7_, float p_71903_8_, float p_71903_9_)
    {
        ...
        else
        {
            ...
            // CraftBukkit end
            p_71903_1_.func_72921_c(p_71903_2_, p_71903_3_, p_71903_4_, j1 + k1);
    ...
    public boolean func_71855_c(IBlockAccess p_71855_1_, int p_71855_2_, int p_71855_3_, int p_71855_4_, int p_71855_5_)
    {
        ...
        {
            int j1 = i1 & 7;
            return j1 == 5 && p_71855_5_ == 1 ? true : (j1 == 4 && p_71855_5_ == 2 ? true : (j1 == 3 && p_71855_5_ == 3 ? true : (j1 == 2 && p_71855_5_ == 4 ? true : j1 == 1 && p_71855_5_ == 5)));
        }
    }
    ...
    public void func_71847_b(World p_71847_1_, int p_71847_2_, int p_71847_3_, int p_71847_4_, Random p_71847_5_)
    {
        if (!p_71847_1_.field_72995_K)
        {
            ...
            if ((l & 8) != 0)
            {
                ...
                {
                    p_71847_1_.func_72921_c(p_71847_2_, p_71847_3_, p_71847_4_, l & 7);
                    int i1 = l & 7;
    ...
    private void func_82535_o(World p_82535_1_, int p_82535_2_, int p_82535_3_, int p_82535_4_)
    {
        ...
        if (flag1 && !flag)
        {
            p_82535_1_.func_72921_c(p_82535_2_, p_82535_3_, p_82535_4_, i1 | 8);
        ...
        if (!flag1 && flag)
        {
            p_82535_1_.func_72921_c(p_82535_2_, p_82535_3_, p_82535_4_, i1);
            this.func_82536_d(p_82535_1_, p_82535_2_, p_82535_3_, p_82535_4_, i1);
            p_82535_1_.func_72909_d(p_82535_2_, p_82535_3_, p_82535_4_, p_82535_2_, p_82535_3_, p_82535_4_);
