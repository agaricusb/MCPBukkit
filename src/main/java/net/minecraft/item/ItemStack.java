...
public final class ItemStack
{
    ...
    {
        this.field_77991_e = (this.field_77993_c > 0) && (this.field_77993_c < 256) && (this.field_77993_c != Block.field_82510_ck.field_71990_ca) ? Item.field_77698_e[this.field_77993_c].func_77647_b(p_77964_1_) : p_77964_1_; // CraftBukkit
    }
    ...
    public void func_77972_a(int p_77972_1_, EntityLiving p_77972_2_)
    {
        if (this.func_77984_f())
        {
            if (p_77972_1_ > 0 && p_77972_2_ instanceof EntityPlayer)
            {
                ...
                for (int l = 0; j > 0 && l < p_77972_1_; ++l)
                {
                    if (EnchantmentDurability.func_92097_a(this, j, p_77972_2_.field_70170_p.field_73012_v))
                    {
                        ++k;
                    }
                }
