...
public class EntityPlayerMP extends EntityPlayer implements ICrafting
{
    ...
    public EntityPlayerMP(MinecraftServer p_i3396_1_, World p_i3396_2_, String p_i3396_3_, ItemInWorldManager p_i3396_4_)
    {
        ...
        this.displayName = this.field_71092_bJ; // CraftBukkit
        this.listName = this.field_71092_bJ; // CraftBukkit
        this.field_82172_bs = true; // CraftBukkit
    }
    ...
    public void func_70645_a(DamageSource p_70645_1_)
    {
        ...
        org.bukkit.event.entity.PlayerDeathEvent event = CraftEventFactory.callPlayerDeathEvent(this, loot, p_70645_1_.func_76360_b(this));
    ...
    public boolean func_70097_a(DamageSource p_70097_1_, int p_70097_2_)
    {
        ...
        else
        {
            ...
            {
                // CraftBukkit - this.server.getPvP() -> this.world.pvpMode
                if (!this.field_70170_p.pvpMode && p_70097_1_ instanceof EntityDamageSource)
                {
    ...
    public void func_71007_a(IInventory p_71007_1_)
    {
        ...
        this.field_71070_bA = container; // CraftBukkit - Use container passed to event
        this.field_71070_bA.field_75152_c = this.field_71139_cq;
        this.field_71070_bA.func_75132_a(this);
    }
    ...
    public void func_71030_a(IMerchant p_71030_1_)
    {
        ...
        this.field_71135_a.func_72567_b(new Packet100OpenWindow(this.field_71139_cq, 6, inventorymerchant.func_70303_b(), inventorymerchant.func_70302_i_()));
