...
public class EntityAIAttackOnCollide extends EntityAIBase
{
    ...
    {
        EntityLiving entityliving = this.field_75441_b.func_70638_az();

        if (entityliving == null)
        {
            return false;
        }
        else if (this.field_75444_h != null && !this.field_75444_h.isAssignableFrom(entityliving.getClass()))
        {
            return false;
        }
        else
        {
            this.field_75442_c = entityliving;
    ...
    {
        EntityLiving entityliving = this.field_75441_b.func_70638_az();
        return entityliving == null ? false : (!this.field_75442_c.func_70089_S() ? false : (!this.field_75437_f ? !this.field_75441_b.func_70661_as().func_75500_f() : this.field_75441_b.func_70649_d(MathHelper.func_76128_c(this.field_75442_c.field_70165_t), MathHelper.func_76128_c(this.field_75442_c.field_70163_u), MathHelper.func_76128_c(this.field_75442_c.field_70161_v))));
    }
    ...
    public void func_75246_d()
    {
        ...
        double d0 = (double)(this.field_75441_b.field_70130_N * 2.0F * this.field_75441_b.field_70130_N * 2.0F);

        if (this.field_75441_b.func_70092_e(this.field_75442_c.field_70165_t, this.field_75442_c.field_70121_D.field_72338_b, this.field_75442_c.field_70161_v) <= d0)
        {
