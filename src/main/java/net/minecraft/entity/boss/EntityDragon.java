    ...
    public void func_70636_d()
    {
        ...
        else
        {
            ...
            if (this.field_70170_p.field_72995_K)
            {
                ...
                {
                    d0 = this.field_70165_t + (this.field_70716_bi - this.field_70165_t) / (double) this.field_70716_bi;
                    d1 = this.field_70163_u + (this.field_70709_bj - this.field_70163_u) / (double) this.field_70716_bi;
                    d2 = this.field_70161_v + (this.field_70710_bk - this.field_70161_v) / (double) this.field_70716_bi;
                    d3 = MathHelper.func_76138_g(this.field_70711_bl - (double) this.field_70177_z);
                    this.field_70177_z = (float)((double) this.field_70177_z + d3 / (double) this.field_70716_bi);
                    this.field_70125_A = (float)((double) this.field_70125_A + (this.field_70712_bm - (double) this.field_70125_A) / (double) this.field_70716_bi);
                    --this.field_70716_bi;
            ...
            if (!this.field_70170_p.field_72995_K)
            {
                this.field_70989_bE = this.func_70972_a(this.field_70986_h.field_70121_D) | this.func_70972_a(this.field_70987_i.field_70121_D);
            }
        }
    }
