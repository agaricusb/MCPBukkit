        ...
        if (!this.field_70170_p.field_72995_K)
        {
                        ...
                        for (int i1 = 0; !flag && i1 <= 10 && i1 >= -10; i1 = i1 <= 0 ? 1 - i1 : 0 - i1)
                        {
                            for (int j1 = 0; !flag && j1 <= 10 && j1 >= -10; j1 = j1 <= 0 ? 1 - j1 : 0 - j1)
                            {
                                ...
                                if (k1 == Block.field_72006_bl.field_71990_ca)
                                {
                                    ...
                                    // CraftBukkit end
                                    this.field_70170_p.func_72926_e(2001, i + i1, j + l, k + j1, Block.field_72006_bl.field_71990_ca + (this.field_70170_p.func_72805_g(i + i1, j + l, k + j1) << 12));
                                    this.field_70170_p.func_72859_e(i + i1, j + l, k + j1, 0);
            ...
            if (this.field_70789_a == null && !this.func_70781_l())
            {
                ...
                if (BlockSilverfish.func_72154_e(l))
                {
                    ...
                    // CraftBukkit end
                    this.field_70170_p.func_72832_d(i + Facing.field_71586_b[l1], j + Facing.field_71587_c[l1], k + Facing.field_71585_d[l1], Block.field_72006_bl.field_71990_ca, BlockSilverfish.func_72153_f(l));
                    this.func_70656_aK();
                    this.func_70106_y();
                }
                else
