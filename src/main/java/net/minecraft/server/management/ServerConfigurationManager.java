...
public abstract class ServerConfigurationManager
{
    ...
    public void func_72355_a(INetworkManager p_72355_1_, EntityPlayerMP p_72355_2_)
    {
        ...
        this.field_72400_f.func_98033_al().func_98233_a(p_72355_2_.field_71092_bJ + "[" + s + "] logged in with entity id " + p_72355_2_.field_70157_k + " at ([" + p_72355_2_.field_70170_p.field_72986_A.func_76065_j() + "] " + p_72355_2_.field_70165_t + ", " + p_72355_2_.field_70163_u + ", " + p_72355_2_.field_70161_v + ")");
    ...
    public String disconnect(EntityPlayerMP entityplayermp)   // CraftBukkit - return string
    {
        ...
        {
            worldserver.func_72900_e(entityplayermp.field_70154_o);
        ...
        else
        {
            ...
            for (int i2 = 0; i2 < this.field_72404_b.size(); ++i2)
            {
                ...
                if (p_82449_9_ != null)
                {
                    ...
                    if (flag1 == p_82449_9_.equalsIgnoreCase(entityplayermp.func_70023_ak()))
                    {
                        continue;
                    }
                }
                ...
                if (p_82449_10_ != null)
                {
                    ...
                    if (flag1 == p_82449_10_.equalsIgnoreCase(s2))
                    {
                        continue;
                    }
                }
                ...
                if (this.func_96457_a((EntityPlayer) entityplayermp, p_82449_8_) && (p_82449_5_ == EnumGameType.NOT_SET.func_77148_a() || p_82449_5_ == entityplayermp.field_71134_c.func_73081_b().func_77148_a()) && (p_82449_6_ <= 0 || entityplayermp.field_71068_ca >= p_82449_6_) && entityplayermp.field_71068_ca <= p_82449_7_)
                {
