...
public class PropertyManager
{
    ...
    public Properties field_73672_b = new Properties(); // CraftBukkit - private -> public
    ...
    public PropertyManager(File p_i3377_1_)
    {
        ...
        if (p_i3377_1_.exists())
        {
            ...
            {
                field_73674_a.log(Level.WARNING, "Failed to load " + p_i3377_1_, exception);
                this.func_73666_a();
            }
            finally
            {
    ...
    public void func_73668_b()
    {
        ...
        {
            field_73674_a.log(Level.WARNING, "Failed to save " + this.field_73673_c, exception);
            this.func_73666_a();
        }
        finally
        {
