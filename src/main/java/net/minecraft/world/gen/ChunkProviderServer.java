...
public class ChunkProviderServer implements IChunkProvider
{
    ...
    public Chunk func_73154_d(int p_73154_1_, int p_73154_2_)
    {
        ...
        {
            MinecraftServer.field_71306_a.severe("Chunk (" + chunk.field_76635_g + ", " + chunk.field_76647_h + ") stored at  (" + p_73154_1_ + ", " + p_73154_2_ + ") in world '" + field_73251_h.getWorld().getName() + "'");
            MinecraftServer.field_71306_a.severe(chunk.getClass().getName());
