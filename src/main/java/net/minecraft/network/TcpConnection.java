...
public class TcpConnection implements INetworkManager
{
    ...
    public TcpConnection(Socket p_i3288_1_, String p_i3288_2_, NetHandler p_i3288_3_, PrivateKey p_i3288_4_) throws IOException   // CraftBukkit - throws IOException
    {
    ...
    private boolean func_74447_i()
    {
        ...
        try
        {
            Packet packet = Packet.func_73272_a(this.field_74477_k, this.field_74485_r.func_72489_a(), this.field_74479_i);
