...
public class CraftPotionBrewer implements PotionBrewer {
    ...
    public Collection<PotionEffect> getEffectsFromDamage(int damage) {
        ...
        List<?> mcEffects = net.minecraft.potion.PotionHelper.func_77917_b(damage, false);
        ...
        for (Object raw : mcEffects) {
            ...
            PotionEffect effect = new PotionEffect(PotionEffectType.getById(mcEffect.func_76456_a()),
                    mcEffect.func_76459_b(), mcEffect.func_76458_c());
